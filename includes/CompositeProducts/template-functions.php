...
function wc_cp_component_options_sorting( $component_id, $product ) {
	...
	if ( $component_ordering_options ) {
		...
		wc_get_template(
			'single-product/component-options-orderby.php',
			array(
				'product'                    => $product,
...
function wc_cp_component_options_filtering( $component_id, $product ) {
	...
	if ( $component_filtering_options ) {
		...
		wc_get_template(
			'single-product/component-options-filters.php',
			array(
				'product'                     => $product,
				'component_id'                => $component_id,
...
function wc_cp_component_options_title( $component_id, $product ) {
	...
	wc_get_template( 'single-product/component-options-title.php', array(), '', Module::instance()->plugin_path() . '/templates/' );
}
...
function wc_cp_component_options( $component_id, $product ) {
	...
	wc_get_template(
		'single-product/component-options.php',
		array(
			'product'                => $product,
			'component_id'           => $component_id,
			'component'              => $component,
...
function wc_cp_component_options_pagination( $component_id, $product, $classes = array() ) {
	...
	if ( Component::options_style_supports( $component->get_options_style(), 'pagination' ) && ! $component->is_static() ) {
		...
		wc_get_template(
			'single-product/component-options-pagination.php',
			array(
				'product'         => $product,
				'component_id'    => $component_id,
				'component'       => $component,
...
function wc_cp_component_options_dropdown( $component_id, $product ) {
	...
	// Dropdown template.
	wc_get_template(
		'single-product/component-options-dropdown.php',
		array(
			'product'       => $product,
			'component_id'  => $component_id,
			'component'     => $component,
...
function wc_cp_component_options_thumbnails( $component_id, $product ) {
	...
	// Thumbnails template.
	wc_get_template(
		'single-product/component-options-thumbnails.php',
		array(
			'product'           => $product,
			'component_id'      => $component_id,
			'component'         => $component,
...
function wc_cp_component_options_radios( $component_id, $product ) {
	...
	wc_get_template(
		'single-product/component-options-radio-buttons.php',
		array(
			'product'           => $product,
			'component_id'      => $component_id,
			'component'         => $component,
