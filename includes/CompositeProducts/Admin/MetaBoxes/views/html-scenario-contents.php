...
<div class="options_group">
	...
	?><div class="hr-section"><?php echo __( 'Configuration', 'wpdrift-woocommerce-modules' ); ?></div><?php
	...
	?><div class="hr-section"><?php echo __( 'Actions', 'wpdrift-woocommerce-modules' ); ?></div><?php
