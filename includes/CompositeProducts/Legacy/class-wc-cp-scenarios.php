...
class Scenarios {
	...
	public static function filter_scenarios_by_type( $scenarios, $type, $scenario_data ) {
		...
		_deprecated_function( __METHOD__ . '()', '3.9.0', 'ScenariosManager::get_ids_by_action()' );
	...
	public static function build_scenarios( $bto_scenario_meta, $bto_data ) {
		...
		_deprecated_function( __METHOD__ . '()', '3.9.0', 'ScenariosManager::get_data()' );
		...
		$result = Helpers::cache_get( 'build_scenarios_' . $request_id );
		...
		foreach ( $bto_data as $group_id => $group_data ) {
			...
			// Otherwise run a query to get all component options (avoid).
				...
				$component_options = Component::query_component_options( $group_data );
			}
		...
		Helpers::cache_set( 'build_scenarios_' . $request_id, $result );
	...
	public static function get_scenarios_for_product( $scenario_meta, $group_id, $product_id, $variation_id, $product_type ) {
		...
		_deprecated_function( __METHOD__ . '()', '3.9.0', 'ScenariosManager::get_scenarios() and Scenario::contains_component_option()' );
	...
	public static function scenario_contains_product( $scenario_data, $group_id, $product_id ) {
		...
		_deprecated_function( __METHOD__ . '()', '3.9.0', 'Scenario::contains_id()' );
	...
	public static function product_active_in_scenario( $scenario_data, $group_id, $product_id, $variation_id, $product_type ) {
		...
		_deprecated_function( __METHOD__ . '()', '3.9.0', 'Scenario::contains_component_option()' );
